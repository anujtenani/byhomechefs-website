                    ...
                    <div className="col-md-6">
                        <div className="card shadow-sm">
                            ...
                            <ul className="list-group list-group-flush">
                                ...
                                <a href={"mailto:akshaykapoor24@gmail.com"} className="d-flex align-items-center justify-content-between list-group-item list-group-item-action p-3">
                                    <span><FiMail size={24} />
                                        <span className={"ms-2"}>Email</span>
                                    </span>
                                    <small>akshaykapoor24@gmail.com</small>
